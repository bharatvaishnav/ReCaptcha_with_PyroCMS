 ...
 */
    ...
    //Remember to obtain the Public and Private key
    var $public_key = "6LdwPtsSAAAAAKwKFzApJY88sJqpLcuDBqQTxKWf"; // Public Key
    var $privkey = "6LdwPtsSAAAAABoBERaHxXrAsZ5y6M02rGA4o5_B"; // Private Key
	var $theme = "clean"; //white,red,blackglass,clean (Available themes)
 ...
 </script><script type="text/javascript" src="'. $server . '/challenge?k=' . $this->public_key . $errorpart . '"></script>
